            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ref={dt}
                        value={products}
                        selection={selectedProducts as any}
                    ...
                    >
                        ...
                        <Column field="code" header="Code" body={codeBodyTemplate} sortable></Column>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="formgrid grid">
                            ...
                            <div className="field col">
                                ...
                                <InputNumber id="quantity" value={product.quantity} onValueChange={(e) => onInputNumberChange(e, 'quantity')} mode="decimal" />
                            </div>
                        </div>
                    </Dialog>
                        ...
                        <div className="skeleton-wrapper">
                            {[...Array(10)].map((_, i) => (
                                <div key={i} className="skeleton-row">
                                    <Skeleton shape="rectangle" width="100%" height="3rem" className="mb-2" />
                                </div>
                            ))}
                        </div>
                    )}
